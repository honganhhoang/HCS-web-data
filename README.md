...
Group 27: Indigenous Student Services: https://www.sfu.ca/students/indigenous.html  >> start with 2 as key(column: name), then 2_i, 2_i_j , etc.

IMPORTANT : if you get to a branch that is the starting point of another team, terminate that branch.
i,j=1,2,..
